        ...
        try {
            ...
            if (args[0] === 'accept') {
                ...
                if (!dbGrupoGacha[pj1] || !dbGrupoGacha[pj2] || 
                    dbGrupoGacha[pj1].owner !== user1 || dbGrupoGacha[pj2].owner !== user2) {
            ...
            if (!dbGrupoGacha[myId] || dbGrupoGacha[myId].owner !== user) return m.reply(`*${config.visuals.emoji2}* El personaje *${plantilla[myId].name}* no es tuyo.`);
            if (!dbGrupoGacha[hisId] || dbGrupoGacha[hisId].owner !== targetJid) return m.reply(`*${config.visuals.emoji2}* El personaje *${plantilla[hisId].name}* no es de esa persona.`);
